/**
 * seed.js: pobla la base de datos con datos de la UAH (EPS).
 * Uso: node seed.js
 */
...
async function seed() {
  ...
  const assignments = {
    ...
    // Carmen: lun/mié 09-14, vie 10-19, da 8 slots de 2h disponibles
    // Pedro: lun-vie 08-20, da 20 slots; en total 28, suficiente para 10 sesiones
    "TEL-1-FF1":     [3, 4],
